...
7. `uv run sourcemode train image gwen` / `train wan gwen --expert low` — print the musubi-tuner sequence (`--run` to execute; `train select <ckpt_dir> --character gwen` ranks checkpoints).
